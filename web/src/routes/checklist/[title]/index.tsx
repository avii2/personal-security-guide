...
export default component$(() => {
  ...
  return (
    ...
    <article class="bg-back p-8 mx-auto w-full max-w-[1200px] rounded-lg shadow-md">
      {!section && (
        <p class="text-center text-lg">Checklist not found or still loading. Please try again.</p>
      )}
      {section && (
        <>
        <h1 class={['gap-2 text-3xl md:text-5xl font-bold capitalize flex flex-wrap']}>
