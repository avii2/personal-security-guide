...
export default component$(() => {
  ...
  return (
  <div class="flex justify-center flex-wrap items-stretch gap-4 md:gap-6 mb-4 relative w-full max-w-6xl mx-auto px-4">
    {(!ignoreDialog.value && (!Object.keys(checkedItems.value).length) ) && (
    <div class="
      px-6 sm:px-10 lg:px-16 py-8 top-1/3 left-1/2 -translate-x-1/2 z-10 max-w-lg w-full
    ...
    <div class="flex justify-center flex-col items-center gap-6">
      {/* Progress Percent */}
      <div class="rounded-box bg-front shadow-md w-full max-w-md md:w-96 p-4">
      ...
      {/* Something ??? */}
      <div class="p-4 rounded-box bg-front shadow-md w-full max-w-md md:w-96 flex-grow">
